/////////////////////////////////////////////////////////////////////////
// TaskDynamicHSDirectTimeEvo implementation (RunSection module) by Gediminas Pazera and Luca Gerhards
//
...
namespace RunSection
{
	...
	TaskDynamicHSDirectTimeEvo::~TaskDynamicHSDirectTimeEvo()
	{
	}
	// -----------------------------------------------------
	// TaskDynamicHSDirectTimeEvo protected methods
	// -----------------------------------------------------
	bool TaskDynamicHSDirectTimeEvo::RunLocal()
	{
		this->Log() << "Running method DynamicHS-Direct-TimeEvo." << std::endl;
	...
	bool TaskDynamicHSDirectTimeEvo::is_identity_matrix(arma::sp_cx_mat &matrix)
	{
	...
	bool TaskDynamicHSDirectTimeEvo::Validate()
	{
